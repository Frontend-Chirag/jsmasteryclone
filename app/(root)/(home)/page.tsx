...
const Page = async ({ searchParams }: Props) => {
  ...
  return (
    <main className="flex-center paddings mx-auto relative w-full max-w-screen-2xl flex-col">
      <div className='z-[-1] w-[100px] h-[100px] linear absolute sm:left-[15px] sm:top-[20%] left-[0px] top-[5%] '></div>
      <div className='z-[-1] w-[100px] h-[100px] linear absolute sm:left-[35px] sm:top-[25%] left-[18px]  top-[10%]'></div>
      <div className='z-[-1] w-[100px] h-[100px] linear absolute sm:left-[15px] sm:top-[30%] left-[0px] top-[15%]'></div>
